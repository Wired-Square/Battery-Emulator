...
const LABELS = {
  ...
  DBLBTR: 'Double battery',
  BATT2COMM: 'Battery 2 interface',
  TRIBTR: 'Triple battery',
...
const VISIBILITY = {
  ...
  BATT2COMM: (s) => s.DBLBTR === true,
  TRIBTR: (s) => s.DBLBTR === true,
  BATT3COMM: (s) => s.DBLBTR === true && s.TRIBTR === true,
  ...
  CNTCTRLDBL: (s) => s.DBLBTR === true,
  CNTCTRLTRI: (s) => s.DBLBTR === true && s.TRIBTR === true,
